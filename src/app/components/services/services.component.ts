  ...
  template: `
    <section class="page-header">
      <div class="container">
        ...
        <p>
          Soluciones profesionales para el mantenimiento y optimización de tus
          equipos
        </p>
      </div>
    </section>
      ...
      <div class="container">
        <div class="overview-content">
          <div class="overview-text">
            ...
            <p class="lead">
              En PrintMaster Solutions entendemos la importancia de mantener tus
              equipos de impresión funcionando correctamente. Por eso, ofrecemos
              servicios técnicos de alta calidad realizados por profesionales
              certificados.
            </p>
            <p>
              Nuestro equipo de técnicos cuenta con más de 15 años de
              experiencia en la industria y está capacitado para resolver
              cualquier problema en tus equipos de impresión, desde impresoras
              de pequeño formato hasta plotters industriales.
            </p>
    ...
    <section class="services-grid">
      <div class="container">
        <div class="section-header">
          ...
          <p>
            Nuestros servicios están diseñados para cubrir todas tus necesidades
            de impresión
          </p>
        </div>
        ...
        <div class="services-list">
          <div class="service-card" *ngFor="let service of services">
            ...
            <a href="tel:+524491298900" class="btn btn-primary">Cotizar</a>
          </div>
        </div>
      </div>
    </section>
  ...
  services = [
    ...
    },
    {
      ...
      features: [
        ...
        'Consumibles originales incluidos',
        'Soporte técnico 24/7',
        'Equipos de respaldo sin costo',
    ...
    },
    {
      ...
      description:
        'Asistencia técnica a distancia para resolver problemas de configuración e instalación.',
      icon: 'fas fa-laptop',
      image:
        'https://images.unsplash.com/photo-1573496130407-57329f01f769?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60',
      features: [
        'Respuesta inmediata',
        'Conexión segura',
  ...
  processSteps = [
    {
      ...
      description:
        'Comunícate con nosotros por teléfono, correo electrónico o a través de nuestro formulario en línea para solicitar asistencia técnica.',
    },
    {
      title: 'Diagnóstico',
      description:
        'Realizamos un diagnóstico completo para identificar el problema exacto. En servicios a domicilio, el técnico lo realiza en el lugar.',
    },
    {
      title: 'Presupuesto',
      description:
        'Te presentamos un presupuesto detallado con los costos de las refacciones y mano de obra para tu aprobación.',
    },
    {
      title: 'Reparación',
      description:
        'Nuestros técnicos certificados realizan la reparación utilizando refacciones originales o compatibles de alta calidad.',
    },
    {
      title: 'Pruebas y Entrega',
      description:
        'Realizamos pruebas exhaustivas para garantizar que todo funcione correctamente antes de entregar el equipo.',
    },
  ];
  ...
  faqs = [
    {
      ...
      answer:
        'El tiempo de reparación depende del tipo de problema y disponibilidad de refacciones. En casos sencillos, podemos resolver el problema en 24-48 horas. Para reparaciones más complejas, el tiempo estimado es de 3 a 5 días hábiles.',
      isOpen: false,
    },
    {
      question: '¿Ofrecen garantía en sus servicios?',
      answer:
        'Sí, todos nuestros servicios de reparación incluyen garantía de 30 días en mano de obra. Las refacciones instaladas tienen garantía del fabricante que va desde 3 hasta 12 meses dependiendo del componente.',
      isOpen: false,
    },
    {
      question: '¿Trabajan con todas las marcas de impresoras?',
      answer:
        'Sí, nuestros técnicos están capacitados para trabajar con todas las marcas principales incluyendo HP, Canon, Epson, Brother, Xerox, Samsung, Lexmark, Kyocera, Ricoh, entre otras.',
      isOpen: false,
    },

    {
      ...
      answer:
        'Sí, ofrecemos servicio de recogida y entrega con costo adicional dependiendo de la zona geográfica. Este servicio debe solicitarse al momento de agendar la reparación.',
      isOpen: false,
    },
  ];
